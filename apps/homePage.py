...
card_homepage = dbc.Card(
    [
        dbc.CardBody([
            html.Div(de.Lottie(options=options, width="10%", height="10%", url=url, speed=1)),
            html.H4("Welcome to Klima Playground", className="card-title", style={'textAlign': 'center'}),
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
