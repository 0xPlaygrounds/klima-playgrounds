...
protocol_metrics_subgraph.ProtocolMetric.staked_supply_percent = SyntheticField(
...
protocol_metrics_subgraph.ProtocolMetric.unstaked_supply_percent = 100 - (protocol_metrics_subgraph.ProtocolMetric.staked_supply_percent +
                                                         protocol_metrics_subgraph.ProtocolMetric.klima_in_lp_percent)

# Treasury CC per klima and ratio
protocol_metrics_subgraph.ProtocolMetric.cc_per_klima = SyntheticField(
