...
how_to_simulation_controls = dcc.Markdown(
    ...
    your selected AKR. To adjust this curve to suite your needs, do the following:
    ...
    - Change the AKR to the current AKR found on KlimaDAO main site or to any speculated AKR of your choice.

    Making these changes will adjust the (3,3) ROI curve and help with visualizing the potential growth of your KLIMA
    over specified number of days. Keep in mind, the AKR you put in is subject to change based on the policy of
...
how_to_read_co_metrics = dcc.Markdown(
    ...
    The calculation is as follows, the AKR is used to project the growth of your initial KLIMA over a year. Once the
